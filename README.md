...
PHP 5.4 support patch has been applied to this Magento version. Magento 1.7.0.2 has an issue to work with MySQL 5.6.
To enable MySQL 5.6 support, the script `enable-mysql-5.6-support` to apply the core fix from [StackOverflow](http://stackoverflow.com/questions/15443448/magento-install-complains-about-missing-innodb-when-it-is-available) has been applied.
...
Sample data is not available for Magento 1.7. The sample data from Magento 1.6 doesn't work with this version, so it's removed.
